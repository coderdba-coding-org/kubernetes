...
# kubectl apply -f configmap-goweb1-default-message.yaml --kubeconfig=/root/.kube/admin.kubeconfig
# kubectl apply -f pod-goweb1.yaml --kubeconfig=/root/.kube/admin.kubeconfig
# kubectl apply -f service.yaml --kubeconfig=/root/.kube/admin.kubeconfig
