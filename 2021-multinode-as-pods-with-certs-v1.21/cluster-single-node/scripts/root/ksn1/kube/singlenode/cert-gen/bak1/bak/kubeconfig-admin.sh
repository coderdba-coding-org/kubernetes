...
kubectl config set-credentials admin:192.168.99.101 \
...
kubectl config set-credentials admin:ksn1 \
--client-certificate=certs/kubelet-ksn1.pem \
--client-key=certs/kubelet-ksn1-key.pem \
--embed-certs=true \
--kubeconfig=kubeconfig/ksn1.admin.kubeconfig
...
kubectl config set-credentials admin:127.0.0.1 \
--client-certificate=certs/kubelet-ksn1.pem \
--client-key=certs/kubelet-ksn1-key.pem \
--embed-certs=true \
--kubeconfig=kubeconfig/127.0.0.1.admin.kubeconfig
