...
--kubeconfig=kubeconfig/192.168.99.101.kubeconfig
...
#kubectl config use-context default --kubeconfig=kubeconfig/192.168.99.101.kubeconfig
...
#--kubeconfig=kubeconfig/ksn1.kubeconfig
...
# Use the context for the node
#kubectl config use-context default --kubeconfig=kubeconfig/ksn1.kubeconfig
...
--kubeconfig=kubeconfig/127.0.0.1.kubeconfig
...
# Use the context for the node
#kubectl config use-context default --kubeconfig=kubeconfig/127.0.0.1.kubeconfig
